...
const pdfType = "legalDecision"; // internal name for the Legal Decision pdf
...
// fields of a "interlocutoryAppeal" message (Agravo de Instrumento)
...
const emitEvent = async () => {
  const result = await updateParamsWithPdf(`${__dirname}/peças/interlocutoria.pdf`);
